...
public class Grafo implements IGrafo{
    ...
    /** Método que verifica se o grafo está vazio, a condição já é feita no retorno; 
     * se a lista de vértice está vazia, retorna "true" (valor lógico, verdadeiro)
     * portanto a lista está vazia, caso não, retorna "false" e há pelo menos um
     * elemento na lista.
     * 
    ...
    /** Método que recebe um nome, caso não haja igual, o vértice é criado e adicionado
     * na lista, recebendo um id para sua identificação.
     *
     * @param nome
     * @return Vertice v
     */
    ...
    /** Método que recebe origem, destino e distância, caso não haja aresta igual,
     * ela é criada e adicionada na lista e o grau dos vértices envolvidos são incrementados.
     *
     * @param origem
     * @param destino
     * @param peso
    ...
    /** Método que recebe origem e destino, caso tal aresta exista, ela é removida
     * da lista e o grau dos vértices envolvidos são decrementados.
     *
     * @param origem
     * @param destino
     * @throws DadoInexistenteException
    ...
    /** Método que recebe origem e destino, caso tal aresta exista, ela é retornado.
     *
     * @param origem
     * @param destino
     * @return a Aresta
    ...
    public double menorPeso(int origem, int destino) {
        origem = origem - 1; destino = destino - 1;   //Adequa id ao nome dos vértices.
    ...
    public List menorCaminho(int origem, int destino, boolean menor) {
        origem = origem - 1; destino = destino - 1;
